...
void err_typemismatch(void); // TYPE MISMATCH
void err_stackmess(void);// GENERIC STACK ERROR (if you play
// with GOTOs, you can create it
// easily)
void err_parm_byref(int n);// UDP/F: PARAMETER IS 'BY
// REFERENCE' SO CONSTANTS DOES
// NOT ALLOWED
...
void err_matop(void);
void err_argerr(void);// Parameter with wrong value
...
void err_fopen(void);
void err_syntaxanysep(const char *seps);// No separator found
