...
#define MSG_PARNUM_LIMIT        "Parameters limit: %d"
...
#define MSG_MISSING_UDP_BODY    "Block not found with FUNC/DEF declared using '='"
...
#define MSG_UNDEFINED_MAP       "Undefined MAP: '%s' or missing parenthesis"
...
#define ERR_WRONG_POLY          "Polygon is incorrect"
...
#define ERR_REF_VAR             "BYREF error. Invalid variable reference"
#define ERR_REF_CIRC_VAR        "BYREF error. Circular reference"
