...
// (DO NOT EDIT: machine generated header) 'SynHighlighterFortran.pas' rev: 6.00
...
public:
	...
	__fastcall virtual TSynFortranSyn(Classes::TComponent* AOwner);
