...
// (DO NOT EDIT: machine generated header) 'SynHighlighterVBScript.pas' rev: 6.00
...
public:
	...
	__fastcall virtual TSynVBScriptSyn(Classes::TComponent* AOwner);
