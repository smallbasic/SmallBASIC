...
*	combine two bitmaps
*/
void bmp_combine(unsigned char *dest, unsigned char *source, int bpl, int lines,
                 int mode)
{
  int ofs, y;
...
*/
void bmp_get(bmp_t * bmp, int x1, int y1, int x2, int y2, int bpp,
             long (*pget) (int x, int y))
{
  int x, y, dx, dx24;
  long c;
  char *dest;
