...
*	@file clibmgr.h
*
*	SmallBASIC, external C-Lib support
*
...
static clib_node	table[MAX_CLIBS];		// table of library nodes, the first element allocated for system purposes
...
void*	clib_call_func(int handle, const char *name, ...)
{
	...
	// c) we will call that function based on number of the parameters that we have
