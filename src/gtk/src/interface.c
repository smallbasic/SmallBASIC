/* $Id: interface.c,v 1.10 2006-03-09 12:07:19 zeeb90au Exp $ */
...
GtkWidget* create_main_window() {
    ...
    GtkWidget* map_key = gtk_menu_item_new_with_mnemonic(_("_Map Key"));
    gtk_menu_append(menubar, map_key);
    g_signal_connect((gpointer)map_key, "activate", G_CALLBACK(on_map_key), NULL);
...
/* End of $Id: interface.c,v 1.10 2006-03-09 12:07:19 zeeb90au Exp $ */
