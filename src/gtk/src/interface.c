/* $Id: interface.c,v 1.8 2006-03-04 00:11:07 zeeb90au Exp $ */
...
GtkWidget* create_main_window() {
    ...
    GtkWidget* menuitem1_menu = gtk_menu_new();
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(menuitem), menuitem1_menu);
    GtkWidget* stop = gtk_image_menu_item_new_from_stock("gtk-stop", accel_group);
    gtk_menu_append(menuitem1_menu, stop);
    g_signal_connect((gpointer)stop, "activate", G_CALLBACK(on_stop_activate), NULL);
    GtkWidget* help = gtk_image_menu_item_new_from_stock("gtk-help", accel_group);
    gtk_menu_append(menuitem1_menu, help);
    g_signal_connect((gpointer)help, "activate", G_CALLBACK(on_help_activate), NULL);
    GtkWidget* separator1 = gtk_separator_menu_item_new();
    gtk_widget_set_sensitive(separator1, FALSE);
    gtk_menu_append(menuitem1_menu, separator1);
    GtkWidget* about = gtk_image_menu_item_new_from_stock("gtk-about", accel_group);
    gtk_menu_append(menuitem1_menu, about);
...
/* End of $Id: interface.c,v 1.8 2006-03-04 00:11:07 zeeb90au Exp $ */
