/* $Id: interface.c,v 1.19 2006-07-26 11:29:48 zeeb90au Exp $ */
...
GtkWidget* create_opendialog(void) {
    GtkWidget* opendialog = hildon_file_chooser_dialog_new(top_level_window, 
...
GtkWidget* create_savedialog(void) {
    GtkWidget* savedialog = hildon_file_chooser_dialog_new(top_level_window, 
...
/* End of $Id: interface.c,v 1.19 2006-07-26 11:29:48 zeeb90au Exp $ */
