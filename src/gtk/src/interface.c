/* $Id: interface.c,v 1.9 2006-03-06 11:45:29 zeeb90au Exp $ */
...
GtkWidget* create_main_window() {
    ...
    GtkWidget* stop = gtk_menu_item_new_with_label(_("Break"));
    gtk_menu_append(menubar, stop);
...
/* End of $Id: interface.c,v 1.9 2006-03-06 11:45:29 zeeb90au Exp $ */
