/* $Id: interface.c,v 1.14 2006-06-27 12:27:49 zeeb90au Exp $ */
...
GtkWidget* create_main_window() {
    ...
    hildon_window_set_menu(main_window, menubar);
...
/* End of $Id: interface.c,v 1.14 2006-06-27 12:27:49 zeeb90au Exp $ */
